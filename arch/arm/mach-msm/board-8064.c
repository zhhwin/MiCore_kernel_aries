...
#define VFE_CAMIF_TIMER1_GPIO	PM8921_GPIO_PM_TO_SYS(30)
...
static struct i2c_board_info bq27520_board_info[] __initdata = {
	{
		I2C_BOARD_INFO("bq27520-battery", 0xaa>>1),
...
#include "mxT336SC10.h"
#include "mxT336SC20.h"
#include "mxT336SC21.h"
...
#include "rmi_firmware_biel_ito_aries.h"
#include "rmi_firmware_laibao_ito_aries.h"
#include "rmi_factory_test_data_tpk_aries_p1.h"
#include "rmi_factory_test_data_tpk_aries_p2.h"
#include "rmi_factory_test_data_biel_aries.h"
#include "rmi_factory_test_data_laibao_aries.h"
...
#define MITWO_GPIO_KEY_VOLUME_UP	PM8921_GPIO_PM_TO_SYS(1)
#define MITWO_GPIO_KEY_VOLUME_DOWN	PM8921_GPIO_PM_TO_SYS(2)

static struct gpio_keys_button mitwo_keys[] = {
	{
		.code           = KEY_VOLUMEUP,
		.gpio           = MITWO_GPIO_KEY_VOLUME_UP,
		.desc           = "volume_up_key",
		.active_low     = 0,
		.type		= EV_KEY,
		.wakeup		= 1,
	...
	{
		.code           = KEY_VOLUMEDOWN,
		.gpio           = MITWO_GPIO_KEY_VOLUME_DOWN,
		.desc           = "volume_down_key",
		.active_low     = 0,
		.type		= EV_KEY,
		.wakeup		= 1,
...
static struct gpio_keys_platform_data mitwo_keys_data = {
	.buttons        = mitwo_keys,
	.nbuttons       = ARRAY_SIZE(mitwo_keys),
};

static struct platform_device mitwo_kp_pdev = {
	.name           = "gpio-keys",
	.id             = -1,
	.dev            = {
		.platform_data  = &mitwo_keys_data,
	},
};
...
static void __init apq8064_cdp_init(void)
{
	...
	if (machine_is_apq8064_mtp() || machine_is_mitwo())
		platform_device_register(&mitwo_kp_pdev);
	else if (machine_is_apq8064_mtp())
